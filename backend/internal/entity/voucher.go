...
import "bookcabin-backend/internal/model"
...
type Voucher struct {
	...
	AircraftType model.AircraftType `json:"aircraft_type" gorm:"column:aircraft_type;type:text;not null"`
...
type CreateVoucherProps struct {
	...
	AircraftType model.AircraftType `json:"aircraft_type" validate:"required,oneof=ATR 'Airbus 320' 'Boeing 737 Max'"`
